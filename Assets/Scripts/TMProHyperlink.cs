...
public class TMProHyperlink : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    [SerializeField]
    ...
    void LateStart() {
        for(int i = 0; i < textMeshPro.textInfo.linkInfo.Length; ++i) {
            startColors = SetLinkColor(i, hoveredColor);
        }
    }
